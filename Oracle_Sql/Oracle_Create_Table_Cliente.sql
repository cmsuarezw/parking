...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "PARKING"."CLIENTE"."ID_CLIENTE" IS 'Identificador de cliente';
...
--------------------------------------------------------
  ...
  ALTER TABLE "PARKING"."CLIENTE" MODIFY ("ID_CLIENTE" NOT NULL ENABLE);
